// Databricks notebook source exported at Tue, 29 Sep 2015 20:14:22 UTC
...
// Spark 1.4
val df = sqlContext.read.parquet("dbfs:/mnt/strata-nyc-dev-bootcamp/ssn/names.parquet")

// Spark 1.3
// val df = sqlContext.parquetFile("dbfs:/home/training/ssn/names.parquet")
