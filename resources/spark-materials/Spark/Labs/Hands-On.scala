// Databricks notebook source exported at Wed, 30 Sep 2015 13:36:16 UTC
// MAGIC %md
...
// MAGIC %sql SELECT firstName from people
...
val df2 = df.filter($"salary" > 100000).filter($"gender" === "M").select($"firstName", $"lastName", $"salary")
display(df2)
